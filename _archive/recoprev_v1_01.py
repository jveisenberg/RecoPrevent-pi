...
top_frame.grid(row=0, ipady='20')
mid_frame.grid(row=1, ipady='20')
bot_frame.grid(row=2, ipady='20')
...
# frame bottom
smil1=tk.Label(bot_frame, text="Smiley 1", font=myFont+myFontXS, bg=mybg, fg=myfg, padx=p_bot_x, pady=p_bot_y)
smil1.grid(row=0, column=0)
smil2=tk.Label(bot_frame, text="Smiley 2", font=myFont+myFontXS, bg=mybg, fg=myfg, padx=p_bot_x, pady=p_bot_y)
smil2.grid(row=0, column=1)
smil3=tk.Label(bot_frame, text="Smiley 3", font=myFont+myFontXS, bg=mybg, fg=myfg, padx=p_bot_x, pady=p_bot_y)
smil3.grid(row=0, column=2)
smil4=tk.Label(bot_frame, text="Smiley 4", font=myFont+myFontXS, bg=mybg, fg=myfg, padx=p_bot_x, pady=p_bot_y)
smil4.grid(row=0, column=3)
smil5=tk.Label(bot_frame, text="Smiley 5", font=myFont+myFontXS, bg=mybg, fg=myfg, padx=p_bot_x, pady=p_bot_y)
